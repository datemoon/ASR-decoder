...
{	
public:
	TfLstm(int input_dim,int output_dim, bool usephole = false):
		...
		_phole_f_c(NULL),_phole_o_c(NULL),_dim(0),_usephole(usephole){ }
	...
	void GetType(string &type) const { type = "TfLstm";}
