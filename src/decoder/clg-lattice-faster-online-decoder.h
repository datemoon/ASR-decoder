#ifndef __CLG_LATTICE_FASTER_ONLINE_DECODE_H__
#define __CLG_LATTICE_FASTER_ONLINE_DECODE_H__
...
class ClgLatticeFasterOnlineDecoder 
{
private:
	struct Token;
public:
	...
	ClgLatticeFasterOnlineDecoder(ClgFst *graph,
