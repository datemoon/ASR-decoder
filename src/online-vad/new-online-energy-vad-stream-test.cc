...
int main(int argc, char* argv[])
{
	try
	{
		...
		VadProcessOpts vad_process_opt("energy-vad-judge", "energy-vad");
		//VadJudgeOptions vad_judge_opt("energy-vad-judge");
		vad_process_opt.Register(&po);
		...
		EnergyVadProcess<BaseFloat> energy_vad(vad_process_opt);
